...
typedef struct packed {
    logic [7:0]  q;
  } axi_vga_reg2hw_offset_reg_t;

typedef struct packed {
    logic [31:0]  q;
  } axi_vga_reg2hw_fifo_depth_reg_t;
  // Register -> HW type
  typedef struct packed {
    ...
    axi_vga_reg2hw_burst_len_reg_t burst_len; // [7:0]
        axi_vga_reg2hw_offset_reg_t offset; //[379:371]
                axi_vga_reg2hw_fifo_depth_reg_t fifo_depth; //[379:371]
  } axi_vga_reg2hw_t;
  ...
  parameter logic [BlockAw-1:0] AXI_VGA_OFFSET_OFFSET = 6'h 38;
  parameter logic [BlockAw-1:0] AXI_VGA_FIFO_DEPTH_OFFSET = 6'h 3c;
  // Register index
  typedef enum int {
    AXI_VGA_CONTROL,
    AXI_VGA_CLK_DIV,
  ...
  parameter logic [3:0] AXI_VGA_PERMIT [16] = '{
    ...
    4'b 0001,  // index[14] AXI_VGA_OFFSET
    4'b 1111  // index[15] AXI_VGA_OFFSET
  };
