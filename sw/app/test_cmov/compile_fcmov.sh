...
# Variables
ASM_FILE="test_fcmov.s"
OBJ_FILE="test_fcmov.o"
ELF_FILE="test_fcmov.riscv"
BIN_FILE="test_fcmov.bin"
MEM_FILE="test_fcmov.mem"
...
# Étape 1 : Assemblage
riscv64-unknown-elf-as -march=rv32imf $ASM_FILE -o $OBJ_FILE
if [ $? -ne 0 ]; then
